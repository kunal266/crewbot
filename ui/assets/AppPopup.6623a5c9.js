import { a as SvelteComponent, i as init, s as safe_not_equal, _ as SPRINTF, e as element, t as text, b as space, c as attr, S as Supports, g as insert, h as append, v as set_data, n as noop, j as detach, K as C, d as src_url_equal, $ as toggle_class, l as listen, p as prevent_default, a0 as run_all, ae as subscribe, T, a6 as handle_promise, x as create_component, H as empty, y as mount_component, a7 as update_await_block_branch, D as transition_in, I as group_outros, E as transition_out, J as check_outros, F as destroy_component, k as getContext, a3 as createEventDispatcher, R as Model, m as component_subscribe, o as onMount, a4 as onDestroy, A as Api, a9 as update_keyed_each, aa as outro_and_destroy_block, ah as flush, f as set_style, aA as setContext, U as Msg, aD as loadLang, q as binding_callbacks } from "./sieve.d6bf62de.js";
import { b as Selector, c as checkSieveConstraint, M as ModelLabel, e as Self } from "./Selector.665da9ec.js";
...
function create_fragment$3(ctx) {
  ...
  return {
    c() {
      ...
      attr(a1, "href", serviceProxy.CFG.URL.ROOT + "#/settings/billing");
...
function create_fragment$2(ctx) {
  ...
  return {
    c() {
      ...
      attr(img, "height", "16");
      attr(img, "class", "mt-4");
      if (!src_url_equal(img.src, img_src_value = serviceProxy.CFG.URL.APP + "/v1/getfavicon?url=" + escape(ctx[5])))
    ...
    p(ctx2, [dirty]) {
      if (dirty & 32 && !src_url_equal(img.src, img_src_value = serviceProxy.CFG.URL.APP + "/v1/getfavicon?url=" + escape(ctx2[5]))) {
        attr(img, "src", img_src_value);
      }
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  onMount(async () => {
    ...
    $$invalidate(1, isActive = await serviceProxy.isActive());
  ...
  async function checkAllForChanges() {
    let res = await serviceProxy.store.SieveStore.find({
      state: 40,
